...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MergedInvoice'
        db.create_table(u'manager_mergedinvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('paid_for_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='merged_invoices_paid', null=True, blank=True, to=orm['manager.Attendee'])),
            ('invoice_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 6, 1, 0, 0), null=True, blank=True)),
        ...
        db.send_create_signal('manager', ['MergedInvoice'])
        ...
        # Adding field 'Invoice.merged_invoice'
        db.add_column(u'manager_invoice', 'merged_invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='invoices', null=True, blank=True, to=orm['manager.MergedInvoice']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MergedInvoice'
        db.delete_table(u'manager_mergedinvoice')

        # Removing M2M table for field attendee on 'MergedInvoice'
        db.delete_table(db.shorten_name(u'manager_mergedinvoice_attendee'))

        # Deleting field 'Invoice.merged_invoice'
        db.delete_column(u'manager_invoice', 'merged_invoice_id')
    ...
    models = {
        ...
        'manager.auctionitem': {
            ...
            'date_received': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'manager.invoice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'manager.mergedinvoice': {
            ...
            'attendee': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'merged_invoices'", 'default': 'None', 'to': "orm['manager.Attendee']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
